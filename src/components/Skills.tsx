  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Bootstrap", level: 80, color: "from-indigo-500 to-purple-500" },
      ]
    },
    {
      title: "Backend",
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "C++", level: 78, color: "from-blue-600 to-indigo-600" },
        { name: "DSA", level: 68, color: "from-red-500 to-rose-500" },
        { name: "OOP", level: 80, color: "from-violet-500 to-purple-500" },
      ]
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {skillCategories.map((category, categoryIndex) => (
            <div 
              key={category.title}
              className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-blue-500/30 transform hover:scale-105 transition-all duration-300 hover:bg-white/15"
            >
              ...
              <div className="mt-8 flex flex-wrap gap-2">
                {category.skills.slice(0, 3).map((skill) => (
                  <span 
                    key={skill.name}
                    className="px-3 py-1 bg-gradient-to-r from-blue-500/30 to-indigo-500/30 rounded-full text-xs text-blue-200 border border-blue-500/50"
                  >
                    {skill.name}
                  </span>
                ))}
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['React', 'JavaScript', 'Node.js', 'Python', 'MongoDB', 'CSS3', 'HTML5', 'Bootstrap', 'Express', 'Git'].map((tech, index) => (
              <div 
                key={tech}
                className="interactive bg-gradient-to-r from-blue-500/20 to-indigo-500/20 backdrop-blur-lg px-6 py-3 rounded-full border border-blue-500/30 text-white hover:scale-110 hover:bg-blue-500/30 transition-all duration-300 cursor-pointer"
