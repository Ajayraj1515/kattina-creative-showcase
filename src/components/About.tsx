        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p className="text-lg">
                🚀 I'm a <span className="text-purple-400 font-semibold">passionate software developer</span> who 
              ...
              <p className="text-lg">
                💡 What started as an exploration has become my <span className="text-blue-400 font-semibold">calling</span>. 
                I'm highly skilled in <span className="text-purple-400">React.js</span> and <span className="text-yellow-400">JavaScript</span>, 
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 text-center transform hover:scale-105 transition-all duration-300">
              ...
              {/* Quote */}
              <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl p-6 border border-purple-500/30">
                ...
                <div className="text-center text-purple-400 font-semibold mt-3">- Ajayraj Kattina</div>
              </div>
            </div>
          </div>
        </div>
